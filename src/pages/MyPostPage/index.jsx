...
const MyPostPage = () => {
  ...
  return (
    <div className="overflow-auto">
                  ...
                  <TableRow>
                    ...
                    <TableCell className="text-left">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => handleOpenChange({id: item._id, title: item.title})}
      ...
      <DialogConfirm open={open} onOpenChange={handleOpenChange} dialogDelete={dialogDelete} handleDelete={handleDelete}/>
    </div>
  );
};
